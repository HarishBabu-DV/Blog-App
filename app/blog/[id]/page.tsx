...
useEffect(()=>{
    ...
    return (
        <>
            {
                data &&  <main className='max-w-[1920px] mx-auto'>
                <div className='bg-gray-200 py-5 md:px-12 lg:px-28'>
                    ...
                    <div className='text-center my-24'>
                        ...
                        <Image src={assets.profile_icon} alt='author image'
                ...
                <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
                    ...
                    <p className='my-3 text-lg'>
                        {data.description} Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat inventore, quisquam deleniti laborum voluptatibus pariatur officiis sunt libero accusamus tenetur, culpa odio odit molestiae totam maxime magni perspiciatis, et porro.
                    </p>
                </div>
                <div className='my-24 '>
